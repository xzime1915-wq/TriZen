...
export const HOME_GLIDE_WHITE_IMAGE = "/products/tripad-v1-white.png";
export const HOME_GLIDE_BLACK_IMAGE = "/products/tripad-v1-black.png";
export const HOME_GLIDE_V2_BLACK_IMAGE = "/products/tripad-v2-black.png";
export const HOME_GLIDE_V2_WHITE_IMAGE = "/products/tripad-v2-white.png";
