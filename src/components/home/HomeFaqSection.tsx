...
export function HomeFaqSection() {
  ...
  return (
    <section className="border-t border-[var(--color-border)] bg-black">
      <div className="container-trizen py-14 md:py-20 lg:py-24 max-w-4xl mx-auto">
        ...
        <p className="mt-6 text-center text-sm sm:text-base font-bold uppercase tracking-wide text-zinc-300">
          {HOME_SEO_SUBTITLE}
        </p>
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="text-sm font-semibold uppercase tracking-[0.2em] text-white transition-colors hover:text-zinc-300"
          >
