  ...
  return (
    <section className="bg-black border-b border-[var(--color-border)]">
      <div className="container-trizen py-20 md:py-24">
        ...
        <h2 className="text-center text-xl md:text-2xl font-bold uppercase tracking-tight text-white mb-14">
          Flexible payment
        </h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {methods.map((m) => (
            <div
              key={m.name}
              className="border border-[var(--color-border)] bg-zinc-950/80 px-6 py-8 text-center"
            >
